...
const submit = () =>
  stubFor({
    ...
    request: {
      url: '/rpApi/resettlement-passport/prisoner/A8731DY/resettlement-assessment/submit?assessmentType=BCST2&useNewDeliusCaseNoteFormat=true&useNewDpsCaseNoteFormat=true&supportNeedsLegacyProfile=false',
      method: 'POST',
    },
    response: {
      status: 200,
