context('Finance and ID - bank account', () => {
  ...
  it('Add bank account application', () => {
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Check your answers before adding a bank account application')
  ...
  const flowForAddDrivingLicence = () => {
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Apply for a Driving licence')
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Check your answers before applying for a')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Driving licence')
  ...
  it('Add 2nd ID application', () => {
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Apply for a Marriage certificate')
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Check your answers before applying for a')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Marriage certificate')
    cy.get('.govuk-summary-list__row > dt').eq(0).should('contain.text', 'Type')
  ...
  it('Update ID application', () => {
    ...
    cy.get('h2.govuk-heading-l').should('contain.text', 'Finance and ID')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Check your answers before completing application for a')
    cy.get('h2.govuk-heading-m').should('contain.text', 'Birth certificate')
