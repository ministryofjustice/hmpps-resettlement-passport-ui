...
describe('getView', () => {
  ...
  it('Happy path with specified query params and data from endpoints', async () => {
    ...
    await request(app)
      .get(
        '/drugs-and-alcohol?prisonerNumber=A1234DY&page=1&createdByUserId=2&supportNeedUpdateFilter=1456&supportNeedUpdateSort=createdDate,ASC',
      )
      .expect(200)
      .expect(res => expect(res.text).toMatchSnapshot())
  ...
  it('Error case - invalid page parameter', async () => {
    await request(app)
      .get('/drugs-and-alcohol?prisonerNumber=A1234DY&page=InvalidValue')
      .expect(500)
  ...
  it('Error case - invalid createdByUserId parameter', async () => {
    await request(app)
      .get('/drugs-and-alcohol?prisonerNumber=A1234DY&page=1&createdByUserId=%2C9')
      .expect(500)
      .expect(res => expectSomethingWentWrongPage(res))
  })
