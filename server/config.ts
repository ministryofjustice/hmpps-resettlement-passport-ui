...
export default {
  ...
  apis: {
    ...
    rpClient: {
      ...
      timeout: {
        response: Number(get('RESETTLEMENT_PASSPORT_API_TIMEOUT_RESPONSE', 30000)),
        deadline: Number(get('RESETTLEMENT_PASSPORT_API_TIMEOUT_DEADLINE', 30000)),
      },
      agent: new AgentConfig(Number(get('RESETTLEMENT_PASSPORT_API_TIMEOUT_RESPONSE', 30000))),
